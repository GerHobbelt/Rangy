/**
 * Simple unit test framework. Written by Tim Down, based on work by Brian McCallister:
 * http://kasparov.skife.org/blog/src/javascript/unit-testing-async-js.html
 *
...
if (!Function.prototype.apply) {
	Function.prototype.apply = function(obj, args) {
		...
		if (typeof obj[methodName] != "undefined") {
			methodName += ("" + Math.random()).slice(2);
		}
		obj[methodName] = this;
